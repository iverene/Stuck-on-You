...
const LoveHuePopup = () => {
  ...
  return (
    <div 
      className={`fixed bottom-6 right-6 z-60 max-w-sm w-full bg-white border border-gray-200 rounded-2xl shadow-2xl p-4 transition-all duration-700 ease-out transform ${
    ...
    >
      ...
      <button 
        ...
        className="absolute top-2 right-2 text-gray-400 hover:text-gray-600 bg-transparent hover:bg-gray-100 p-1 rounded-full transition-colors"
      >
        <X size={16} />
      </button>
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex flex-col gap-1 pr-4">
          ...
          <p className="font-sans text-gray-600 text-sm leading-snug mb-3">
